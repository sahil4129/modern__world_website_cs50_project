    ...
    <table border="2" bordercolor="#000000" align="center" cellspacing="2">
         ...
         <td>Feedback</td>
          <td>Action</td>
              <?php
	 include("connect.php");
	$ab = mysqli_query($conn,"select * from queries") or die(mysql_error());	
      ...
      ?>
       ...
       <td colspan="2"> <center><a href="deletefeed.php?id=<?php echo $row['sno'];?>"><input type='button' value='Delete' name="ss">  </a></center><br />
              </tr>   
